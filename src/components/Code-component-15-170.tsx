    ...
    <div className="min-h-screen" style={{ backgroundColor: '#335536' }}>
      ...
      <div className="relative h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white text-center px-4 tracking-wider transform transition-all duration-500 hover:scale-110 hover:text-green-300 cursor-default">
