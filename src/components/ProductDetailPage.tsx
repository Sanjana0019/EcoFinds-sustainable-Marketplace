  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center mb-6">
        <button
          onClick={onBack}
          className="p-2 -ml-2 rounded-lg hover:bg-white/10 transition-colors text-white"
        >
          <ArrowLeft size={20} />
        </button>
        <h1 className="text-lg font-medium text-white ml-2">Product Details</h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-3xl font-bold text-green-400 mb-4">${product.price}</p>
          </div>

          {/* Product Details Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Card className="border border-gray-600 bg-white/10">
